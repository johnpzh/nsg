...
IndexNDNSG::IndexNDNSG(
        const size_t dimension,
        const size_t n,
        IndexND *initializer)
        : IndexND(dimension, n), initializer_(initializer)
{}
//IndexNDNSG::IndexNDNSG(const size_t dimension, const size_t n, Metric m,
//                   Index *initializer)
...
//void IndexNDNSG::Save(const char *filename)
//{
...
void IndexNDNSG::Load(const char *filename)
{
...
//void IndexNDNSG::Load_nn_graph(const char *filename)
//{
//    std::ifstream in(filename, std::ios::binary);
//    if (!in.is_open()) {
...
//}
//
//void IndexNDNSG::get_neighbors(const float *query, const Parameters &parameter,
...
//}
//
//void IndexNDNSG::init_graph(const Parameters &parameters)
//{
...
//}
//
//void IndexNDNSG::sync_prune(unsigned q, std::vector<Neighbor> &pool,
...
//void IndexNDNSG::InterInsert(unsigned n, unsigned range,
...
//void IndexNDNSG::Link(const Parameters &parameters, SimpleNeighbor *cut_graph_)
//{
//    /*
...
//}
//
//void IndexNDNSG::Build(size_t n, const float *data, const Parameters &parameters)
//{
...
//void IndexNDNSG::Search(const float *query, const float *x, size_t K,
...
//}
//
//void IndexNDNSG::SearchWithOptGraph(const float *query, size_t K,
//                                  const Parameters &parameters, unsigned *indices)
//{
...
void IndexNDNSG::OptimizeGraph(float *data)
...
//void IndexNDNSG::DFS(boost::dynamic_bitset<> &flag, unsigned root, unsigned &cnt)
//{
//    unsigned tmp = root;
...
//}
//
//void IndexNDNSG::findroot(boost::dynamic_bitset<> &flag, unsigned &root,
//                        const Parameters &parameter)
//{
//    unsigned id = nd_;
//    for (unsigned i = 0; i < nd_; i++) {
...
//}
//
//void IndexNDNSG::tree_grow(const Parameters &parameter)
//{
//    unsigned root = ep_;
//    boost::dynamic_bitset<> flags{nd_, 0};
...
//        // Get the distance from the vertex to the query (refer to IndexNDNSG::SearchWithOptGraph()).
...
//}
//
//// Overloading of IndexNDNSG::SearchWithOptGraph:
//void IndexNDNSG::SearchWithOptGraph(
//        const float *query,
//        size_t K,
...
//
//
//void IndexNDNSG::SearchWithOptGraphMeasurement(
//        const float *query,
//        size_t K,
//        const Parameters &parameters,
//        unsigned *indices)
...
//void IndexNDNSG::get_candidate_queues(
//        const float *query,
//        size_t K,
//        const Parameters &parameters,
...
//}
//
//void IndexNDNSG::get_recall_for_all_queries(
//        unsigned query_num,
//        unsigned t_K,
...
// */
//void IndexNDNSG::DegreeDistribution(
