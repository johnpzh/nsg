//
// Created by Zhen Peng on 10/4/19.
//
/**
 * Some running time measurement for the optimized searching function.
 * Overloading the optimized searching function.
 */
...
//#pragma omp parallel for
            for (unsigned i = 0; i < query_num; i++) {
                index.SearchWithOptGraphMeasurement(query_load + i * dim, K, paras, res[i].data());
            }
            // Ended by Johnpzh
