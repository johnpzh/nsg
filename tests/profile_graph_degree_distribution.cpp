//
// Created by Zhen Peng on 10/15/19.
//
...
//    }
    ...
    index.DegreeDistribution(degree_to_count);

    printf("Degree Frequency\n");
    for (unsigned degree = 0; degree < degree_to_count.size(); ++degree) {
        printf("%u %d\n", degree, degree_to_count[degree]);
    }
